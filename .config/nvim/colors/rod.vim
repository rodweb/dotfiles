...
let s:light_red       = { "gui": "#E32791", "cterm": "167"   }
...
let s:light_purple    = { "gui": "#6855DE", "cterm": "161"  }
...
call s:h("MyTodo",        {"bg": s:purple, "fg": s:norm})
...
" __Quickfix__
call s:h("QuickFixLine",  {"fg": s:comment })
...
" __PmenuSel__
call s:h("PmenuSel",      {"fg": s:norm, "bg": s:selection, "gui": "bold"})
